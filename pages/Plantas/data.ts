export const plants = [
  ...
  },
  {
    "name": [
      "manzanilla"
    ],"imagen": "https://static.tuasaude.com/media/article/cy/iu/beneficios-do-cha-de-camomila_13767_l.jpg",
    "descripcion": "Comúnmente conocida como manzanilla o camomila común o romana es una hierba perenne de la familia de las asteráceas, nativa de Europa que se encuentra en campos secos y alrededor de jardines y terrenos cultivados en Europa, América del Norte y América del Sur.",
    "productos": "Es utilizada tradicionalmente en productos para el cuidado del cabello y de la piel en infusiones, perfumes y cosméticos,​y para dar sabor y aromatizar alimentos. También se utiliza ampliamente en medicina tradicional, aunque no hay evidencia científica suficiente que respalde las propiedades medicinales que se le atribuyen.",
    "usos": [
      "Infecciones",
      "Colicos",
      "Tos",
  ...
  
  {
    ...
    "contraindicaciones": "No deben tomar junto con anticoagulantes , durante el embarazo , personas con hipertension , personas con diabetes (debido a los medicamentos de la insulina), personas con problemas en el corazon o tambien con hemofilia",
    "preparacion": " Se lo puede consumir fresco o crudo, en polvo con el té o licuándolo en forma de bebida , ya que la forma de actuar de este es instantanea y con una pequeña dosis , aunque dependiendo de las necesidades se puede administrar lo que se requiera hasta que se sienta mejor. Aunque lo mejor es conseguirlo fresco por posibles tratamientos que le dan cuando esta seco , ya que puede haber sido expuesto a metodos que le quitan las cualidades naturales"
  }
];
